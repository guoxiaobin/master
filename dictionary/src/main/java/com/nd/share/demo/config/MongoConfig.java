...
@EnableMongoRepositories(basePackages = {
        "com.nd.share.demo.repository"
})
@PropertySource(value = {"classpath:mongo.properties", "classpath:config.properties", "classpath:waf.properties"})
...
//        if (StringUtils.equals("pressure", deployEnv)) {
//            return mongoDbName;
//        } else {
...
//        } else {
            ...
            MongoOptions mongoOptions = client.getMongoOptions();
            mongoOptions.setConnectionsPerHost(200);
            mongoOptions.setThreadsAllowedToBlockForConnectionMultiplier(15);
//        }
        return client;
    }
